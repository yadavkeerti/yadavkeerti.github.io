...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/gee_himalayan_hazard.jpg" title="Himalayan Hazard Platform Dashboard" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Interactive Google Earth Engine Apps Dashboard displaying Multi-Criteria Risk & Disaster Vulnerability Intelligence with live buffer analytics and hydrological networks.
</div>
...
- **🌧️ Hydrological Risk:** Continuously tracks **12 strategic Himalayan river corridors** (e.g., Seti, Narayani, Saptakoshi, Kavre/Roshi Khola) using 24-hour rainfall (>= 50 mm) and 3-day soil saturation levels.
- **🧊 GLOF Thermal Surges:** Evaluates high-altitude glacial lakes (*Imja Tsho*, *Tsho Rolpa*, *Thulagi*) for peak daily thaw temperatures (> 2.0°C).
